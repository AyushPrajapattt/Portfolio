...
/** Shared props so every icon inherits currentColor + sizing from CSS. */
...
export function LocationIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base(props)}>
      <path d="M12 21s-7-6.27-7-11a7 7 0 0 1 14 0c0 4.73-7 11-7 11Z" />
